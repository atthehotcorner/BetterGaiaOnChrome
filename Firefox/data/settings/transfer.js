...
*/
/*global localStorage: false, console: false, $: false, chrome: false, unescape: false, prefs: false */
/*jshint sub:true */
...
var Transfer = {
    ...
    init:function() {
        ...
        if (typeof(this.push['usertags.list']) == 'object') this.saveMax('usertags.list', true);
