/*global chrome: false, console: false, data: false, Handlebars: false, prefs: false, require: false, self: false*/
...
var Settings = {
    ...
    pageInit: function(pageName) {
        ...
        if (pageName == 'Shortcuts') {
            ...
            $('.page[data-page="Shortcuts"] .save').on('click', function() {
                ...
                Settings.set('header.shortcuts.list', links);
            ...
            $.ajax({
                ...
                $.each(data, function(key, headers) {
                    ...
                    $.each(headers, function(name, url) {
                        ...
                        if (url[0] != 'default' && url[0].substring(0,7) != 'http://') url[0] = host + url[0];
                        if (url[1] != 'default' && url[1].substring(0,7) != 'http://') url[1] = host + url[1];
            ...
            $('.page[data-page="PostFormat"] .save').on('click', function() {
                ...
                Settings.set('format.list', formats);
            ...
            $('.page[data-page="UserTags"] .save').on('click', function() {
                ...
                Settings.set('usertags.list', tags);
    ...
    init: function() {
        ...
        $('#pages').on('change', '.page.loaded *[data-pref]', function() {
            ...
            // Set in Storage
            if (prefs.default[pref] == save[pref]) Settings.unset(pref);
            else Settings.set(pref, save[pref]);
        });
